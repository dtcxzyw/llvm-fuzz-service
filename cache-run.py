...
common_opts = "-Wno-narrowing -DNDEBUG -g0 -ffp-contract=on -w -mllvm -no-stack-coloring -I" + csmith_dir + "/include "
...
def csmith_test(test):
    ...
    os.rename(file_c, file_c + "." + ref_output.decode('utf-8').strip().removeprefix("checksum = "))
    os.remove(file_ref)
